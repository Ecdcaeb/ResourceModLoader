                        ...
                        for(MethodNode mn:cn.methods){
                            ...
                            if ("init".equals(mn.name)){
                                ASMUtil.injectBefore(mn.instructions, ()->{
                                    ...
                                    hook.add(new MethodInsnNode(Opcodes.INVOKESTATIC,"mods/rml/api/event/CraftingHelperInitEvent","post","()V",false));
                                    return hook;
                    ...
                    (cn)->{
                        for(MethodNode mn:cn.methods){
                            ...
                            if ("identifyDuplicates".equals(mn.name)){
                                ...
                                injectList.add(new MethodInsnNode(Opcodes.INVOKESTATIC,"mods/rml/core/RMLModDiscover","inject","(Ljava/util/List;)V",false));
                                ...
                                while (iterator.hasNext()){
                                    ...
                                    if (node instanceof MethodInsnNode){
                                        ...
                                        if ("resizeContent".equals(methodInsnNode.name)){
                                            ...
                                            iterator.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "mods/rml/api/event/client/gui/ModMenuInfoEvent", "post", "(Ljava/util/List;Ljava/lang/Object;Lnet/minecraftforge/fml/client/GuiModList;Lnet/minecraftforge/fml/common/ModContainer;)Ljava/util/List;", false));
                        ...
                        for(MethodNode mn:cn.methods){
                            ...
                            if (m_193061.is(mn)){
                                ASMUtil.injectBefore(mn.instructions, ()->{
                                    ...
                                    hook.add(new MethodInsnNode(Opcodes.INVOKESTATIC,"mods/rml/api/event/FunctionLoadEvent","post","(Lnet/minecraft/advancements/FunctionManager;)V",false));
                                    return hook;
                                }, (node)->node.getOpcode() == Opcodes.RETURN);
                                return ClassWriter.COMPUTE_MAXS | ClassWriter.COMPUTE_FRAMES;
                            }
                    ...
                    (cn)->{
                        for(MethodNode mn: cn.methods){
                            ...
                            if ("<clinit>".equals(mn.name)){
                                ASMUtil.injectBefore(mn.instructions, ()->{
                                    InsnList hook=new InsnList();
                                    hook.add(new MethodInsnNode(Opcodes.INVOKESTATIC,"mods/rml/api/event/LootTableRegistryEvent","post","()V",false));
                                    return hook;
                                }, (node)->node.getOpcode()==Opcodes.RETURN);
                                return ClassWriter.COMPUTE_MAXS  | ClassWriter.COMPUTE_FRAMES;
                            }
                    ...
                    (cn)->{
                        for(MethodNode mn:cn.methods){
                            if ("distributeStateMessage".equals(mn.name) && "(Lnet/minecraftforge/fml/common/LoaderState;[Ljava/lang/Object;)V".equals(mn.desc)){
                                ...
                                hook.add(new MethodInsnNode(Opcodes.INVOKESTATIC,"mods/rml/compat/fml/RMLFMLHooks","beforeFMLBusEventSending","(Lnet/minecraftforge/fml/common/LoadController;Lnet/minecraftforge/fml/common/LoaderState;[Ljava/lang/Object;)V",false));
                            ...
                            if (m_175276.is(mn)){
                                ...
                                ASMUtil.injectBefore(mn.instructions,
                                        () -> {
                                            ...
                                            hook.add(new VarInsnNode(Opcodes.ALOAD, 1));
                                            hook.add(new VarInsnNode(Opcodes.ALOAD, 0));
                                            hook.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "mods/rml/api/event/client/gui/HandleComponentEvent", "postClick", "(Lnet/minecraft/util/text/ITextComponent;Lnet/minecraft/client/gui/GuiScreen;)Z", false));
                                ...
                                ASMUtil.injectBefore(mn.instructions,
                                        () -> {
                                            ...
                                            hook.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "mods/rml/api/event/client/gui/HandleComponentEvent", "postHover", "(Lnet/minecraft/util/text/ITextComponent;Lnet/minecraft/client/gui/GuiScreen;II)V", false));
                                            return hook;
                                        }, (node)->{
