...
public record List(TypeTemplate element) implements TypeTemplate {
    ...
    public static final class ListType<A> extends Type<List<A>> {
        ...
        @Override
        public <FT, FR> Either<TypedOptic<List<A>, ?, FT, FR>, FieldNotFoundException> findTypeInChildren(final Type<FT> type, final Type<FR> resultType, final TypeMatcher<FT, FR> matcher, final boolean recurse) {
