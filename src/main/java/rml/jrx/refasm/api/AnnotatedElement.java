...
public interface AnnotatedElement {
     ...
     * @since 1.5
     */
    AnnotationReference getAnnotation(Class annotationClass);
     ...
     * @since 1.5
     */
    AnnotationReference[] getAnnotations();
     ...
     * @since 1.8
     */
    default AnnotationReference[] getAnnotationsByType(Class annotationClass) {
        /*
     ...
     * @since 1.8
     */
    default AnnotationReference getDeclaredAnnotation(Class annotationClass) {
     ...
     * @since 1.8
     */
    default AnnotationReference[] getDeclaredAnnotationsByType(Class annotationClass) {
        Objects.requireNonNull(annotationClass);
     ...
     * @since 1.5
     */
    AnnotationReference[] getDeclaredAnnotations();
}
